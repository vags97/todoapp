...
![Error al hacer push](failed-to-push.png)
    ...
    Para arreglar esto __Persona B__ deberá descargar los cambios haciendo `git pull` .  Al hacer pull se tendrá que juntar (merge) la versión del repositorio con la versión local, es por esto que te aparecerá un editor con un mensaje parecido a este: 
...
Al final del README están las instrucciones de cómo correr la app en locarl. Ambas personas deberán seguir estos pasos y asegurarse que la app funciona. 
Hasta ahora tenemos una TODO list en la que podemos agregar tareas y asignarles una categoría.
